...
<div class="h-full sm:hidden">
    <VerticalPanes>
        <div class="bg-base-300" slot="top">
            <svelte:component this={panes[0].component} {...panes[0].props} />
        </div>
        <div class="bg-base-300" slot="down">
            <svelte:component this={panes[1].component} {...panes[1].props} />
        </div>
    </VerticalPanes>
</div>
